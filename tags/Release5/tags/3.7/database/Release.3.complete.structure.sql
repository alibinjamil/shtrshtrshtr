...
-- -Date/Time: March 06, 2010 20:39:15
...
IF @@TRANCOUNT=0 BEGIN TRANSACTION
GO
ALTER TABLE [dbo].[un_exchange_rates]
	ADD [html_currency_code] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
IF @@ERROR<>0 
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to add column dbo.un_exchange_rates.html_currency_code')
END
GO
IF @@TRANCOUNT=0 BEGIN TRANSACTION
GO
ALTER TABLE [dbo].[un_entity_details_multi_add]
	ALTER COLUMN [country] [varchar](60) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
GO
IF @@ERROR<>0 
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to alter column dbo.un_entity_details_multi_add.country')
END
GO
IF @@TRANCOUNT=0 BEGIN TRANSACTION
GO
...
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to alter stored procedure dbo.AddressSelect')
END
GO
...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[CustomerSelectById]
	@entity_id int
AS
	SET NOCOUNT ON;
...
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to add stored procedure dbo.CustomerSelectById')
END
GO
SET QUOTED_IDENTIFIER OFF
GO
...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ExchangeRateSelectByCountryCode]
    
    @countryCode char(3)
AS
    SET NOCOUNT ON;
SELECT     top 1   un_exchange_rates.*
FROM            un_exchange_rates
...
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to add stored procedure dbo.ExchangeRateSelectByCountryCode')
END
GO
SET QUOTED_IDENTIFIER OFF
GO
...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[WishListForUserByProductId]
	@user_id int,
	@product_id int
AS
	SET NOCOUNT ON;
...
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to add stored procedure dbo.WishListForUserByProductId')
END
GO
SET QUOTED_IDENTIFIER OFF
GO
...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[WishListSelectById]
	@wish_list_id int
AS
	SET NOCOUNT ON;
SELECT        un_wish_list.*
...
Begin
	IF @@TRANCOUNT>0 ROLLBACK TRANSACTION
	INSERT INTO #ErrorLog (errno,errdescr) values(@@ERROR,'Failed to add stored procedure dbo.WishListSelectById')
END
GO
SET QUOTED_IDENTIFIER OFF
GO
